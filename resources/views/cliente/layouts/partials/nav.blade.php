<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #638933; padding-top: 0px;">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="" style="background-color: #638933; color: #fff;"><span class="fa fa-quora" aria-hidden="true"></span>uetzalEdu</a>
          </div>
      
          <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li><a href="" style="color: #fff;"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <img src="{{ asset('/img/avatar.png')}}" style="height:23px;width:23px" class="img-responsive img-circle">
                </a>
                <ul class="dropdown-menu">
                  <li><a href="">Action</a></li>
                  <li><a href="">Another action</a></li>
