...
.nav-tabs>li>a:hover, .nav-tabs>li>a:focus:hover {
  ...
  <div class="container-fluid" style="background-image: url('../img/cursos/imagen1.png');background-repeat: no-repeat;background-size: cover;background-attachment: fixed;background-position: center;">
