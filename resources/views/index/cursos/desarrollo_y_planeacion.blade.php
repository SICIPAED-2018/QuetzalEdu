...
.nav-tabs>li.active>a, .nav-tabs>li.active>a:focus, .nav-tabs>li.active>a:hover, .nav-tabs>li.active>a:focus:hover{
    border-bottom: solid 1px #f0ca7c;
...
.nav-tabs>li>a:hover, .nav-tabs>li>a:focus:hover {
  ...
  <div class="container-fluid" style="background-image: url('../img/cursos/imagen3.png');background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
    <div class="row" style="padding: 25px;">
      <div class="col-md-6" style="background-color:#f0ca7c;border-radius: 5px;">
        <h4 style="color: #fff;">Desarrollo y planeación</h4>
      </div>     
    </div>
    <div class="col-md-8 col-md-offset-2">
      <video width="700" controls style="width: 100%;height: auto;border: solid 1px #f0ca7c;">
      ...
      <div class="col-md-8" style="padding-left: 60px;padding-top: 20px;">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="info-tab">
              <h4 style="font-weight: bold;">Desarrollo y planeación</h4>
