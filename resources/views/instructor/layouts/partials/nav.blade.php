    ...
    <a href="{{url('/home')}}" class="logo" style="background-color: #285675;">
    ...
    <nav class="navbar navbar-static-top" style="background-color: #285675;">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer" style="border-top: solid 1px #fff;">
                <div class="pull-left">
                  <a href="" class="btn btn-success btn-flat"><i class="glyphicon glyphicon-edit"></i> Perfil</a>
                </div>
